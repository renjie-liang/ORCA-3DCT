...
class GREEN:
    def __init__(self, model_name, output_dir=".", cpu=False, compute_summary_flag=True):
        super().__init__()
        # compute_summary_flag=False skips the representative-sentence clustering
        # (SentenceTransformer/mpnet). The mean/std GREEN score is unaffected.
        self.compute_summary_flag = compute_summary_flag
