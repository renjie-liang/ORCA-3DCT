...
sbatch --parsable --time=00:40:00 --partition=hpg-default --account=anon --ntasks=1 --cpus-per-task=2 --mem=16gb \
  --job-name=sc_avgpack_b27_density --output=./results_llm/slurm_logs/%x_%j.out --error=./results_llm/slurm_logs/%x_%j.err \
  ...
  --wrap="export MAMBA_EXE=/home/anon/micromamba MAMBA_ROOT_PREFIX=/blue/anon/anon/micromamba; \
    ...
    python ./llm_engine/score_sweep.py --run_dir ./results_llm/s1sweep_b27/vqa_single_colipri_avgpack_b27__density/vqa_single_colipri_avgpack_b27__density__s1 --gold ./data/vqa/per_family/valid_density.json"
